  ...
  return (
    ...
    >
      ...
      <div
        {...attributes}
        {...listeners}
        className="absolute top-2 left-2 z-10 cursor-grab active:cursor-grabbing p-1.5 bg-background/80 backdrop-blur-sm rounded opacity-0 group-hover:opacity-100 transition-opacity"
      >
...
export const ProjectSettings = () => {
  ...
  const [viewMode, setViewMode] = useState<'table' | 'cards'>(() => {
    if (typeof window !== 'undefined') {
      return (localStorage.getItem('projectViewMode') as 'table' | 'cards') || 'cards';
    }
    return 'cards';
  });
